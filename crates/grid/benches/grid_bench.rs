...
pub fn from_areas(c: &mut Criterion) {
    ...
    group.bench_with_input(BenchmarkId::from_parameter("Iter Over Mut"), &Area::new(0, 0, 999, 999), |b, area| {
    ...
    group.bench_with_input(BenchmarkId::from_parameter("Iter"), &Area::new(0, 0, 999, 999), |b, _| {
